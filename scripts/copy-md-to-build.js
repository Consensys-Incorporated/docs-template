 ...
 *   docs/path/to/page.md        → build/path/to/page.md
 *   docs/path/to/dir/index.md   → build/path/to/dir.md
 *
 * This lets agents request, e.g.:
 *   https://your-site.example.com/get-started/install.md
 *
 * Update SITE_URL below to match your deployed site URL.
 */
...
const SITE_URL = process.env.SITE_URL || "https://your-site.example.com";
